create or alter procedure nba.sp_Predictions_HigherMarginOfVictoryLastSeason_ForSeason (
  @SeasonStartYear int
...
begin
  ...
  declare @PredictionModelId int = ( select Id
                                     ...
                                     where  Name = 'HigherMarginOfVictoryLastSeason' );
  ...
  select @PredictionModelInstanceId
       , g.Id
       , case
           when homeLastSeason.MarginOfVictory > awayLastSeason.MarginOfVictory then g.HomeTeamIdentifier
...
grant execute on nba.sp_Predictions_HigherMarginOfVictoryLastSeason_ForSeason to roleNba;
go