create or alter procedure nba.sp_Predictions_HigherOffensiveRatingLastSeason_ForSeason (
  @SeasonStartYear int
...
begin
  ...
  declare @PredictionModelId int = ( select Id
                                     ...
                                     where  Name = 'HigherOffensiveRatingLastSeason' );
  ...
  select @PredictionModelInstanceId
       , g.Id
       , case
           when homeLastSeason.OffensiveRating > awayLastSeason.OffensiveRating then g.HomeTeamIdentifier
...
grant execute on nba.sp_Predictions_HigherOffensiveRatingLastSeason_ForSeason to roleNba;
go